...
![](images/2bit_hash.png){.nostretch fig-align="center" style="max-height:500px"}
...
![](images/larson.png){.nostretch fig-align="center" style="max-height:450px; max-width:60%"}
...
![](images/markov_worm_dark.png){.nostretch fig-align="center" style="max-height:450px; max-width:60%"}
...
![](./images/bioreactor_v3.png){.nostretch fig-align="center" style="max-height:400px; max-width:55%"}
...
<video src="images/Composite-1.mp4" controls autoplay loop muted playsinline style="max-width:70%; max-height:65vh; display:block; margin:0 auto;"></video>
...
<video src="images/GalHis-Gellan-Series012-2.mp4" controls autoplay loop muted playsinline style="max-width:55%; max-height:450px; display:block; margin:0 auto;"></video>
