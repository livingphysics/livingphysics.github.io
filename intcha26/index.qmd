...
![](images/lac_operon_dark.png){fig-align="center" width="55%"}
...
![](images/logic_mining.png){fig-align="center"}
...
![](images/biological_circuit_dark.png){fig-align="center"}
...
![](images/2bit_hash.png){fig-align="center"}
::: footer
...
![](images/larson.png){fig-align="center" width="65%"}
...
![](images/markov_worm_dark.png){fig-align="center" width="75%"}
...
::: incremental
 ...
 - In a system that is composed of components whose behavior we know how to describe
:::
...
::: {.fragment}
![](images/erez_dark.png){fig-align="center" width="60%"}
:::
...
![](./images/bioreactor_v3.png){fig-align="center" width="75%"}
...
display(plot(gal, glu1, layout=(2, 1), size=(900, 560)))
```
...
display(plot(glu1, glu2, layout=(3, 1), size=(900, 780)))
```
...
![Time-lapse of 2 colonies growing under a glass coverslip on a +glu-his-leu agar plate](./images/Composite-1.gif)


## Improved Colony Assay
![Time-lapse of 2 colonies growing under a glass coverslip on a +glu-his-leu agar plate](./images/GalHis-Gellan.lif%20-%20Series012-2.gif)
...
display(plot(p_od, p_dt, p_temp; layout=(3, 1), size=(1000, 700),
             legend=:topleft, left_margin=10Plots.mm))
```
