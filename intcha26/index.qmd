...
![](images/larson.png){.nostretch fig-align="center" style="max-height:65vh; max-width:65%"}
...
![](images/markov_worm_dark.png){.nostretch fig-align="center" style="max-height:65vh; max-width:75%"}
